...
import { TrendingUp, Users, UserMinus, HeartHandshake, Target, Link2, FileText, Percent, PiggyBank, ArrowRight } from "lucide-react";
import { useLocale } from "@/i18n/useLocale";
import { LocaleMeta } from "@/i18n/LocaleMeta";
import { pickFreeTools } from "@/content";

const iconMap = { arr: TrendingUp, cac: Users, churn: UserMinus, ltv: HeartHandshake, roas: Target, utm: Link2, llms: FileText, gross: Percent, net: PiggyBank } as const;
