...
export const STATIC_EN = [
  ...
  "/en/free-marketing-tools/marketing-tools",
  "/en/free-marketing-tools/saas-tools",
  "/en/free-marketing-tools/ecommerce-tools",
...
export const ROUTE_PAIRS = [
  ...
  { tr: "/ucretsiz-araclar/pazarlama-araclari", en: "/en/free-marketing-tools/marketing-tools" },
  { tr: "/ucretsiz-araclar/saas-araclari", en: "/en/free-marketing-tools/saas-tools" },
  { tr: "/ucretsiz-araclar/e-ticaret-araclari", en: "/en/free-marketing-tools/ecommerce-tools" },
...
export function sitemapEntries() {
  ...
  "/ucretsiz-araclar/pazarlama-araclari": { changefreq: "weekly", priority: "0.8" },
  "/en/free-marketing-tools/marketing-tools": { changefreq: "weekly", priority: "0.8" },
  "/ucretsiz-araclar/saas-araclari": { changefreq: "weekly", priority: "0.8" },
  "/en/free-marketing-tools/saas-tools": { changefreq: "weekly", priority: "0.8" },
  "/ucretsiz-araclar/e-ticaret-araclari": { changefreq: "weekly", priority: "0.8" },
  "/en/free-marketing-tools/ecommerce-tools": { changefreq: "weekly", priority: "0.8" },
